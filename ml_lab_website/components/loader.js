/**
 * Component Loader for ML Lab Website
...
(function() {
    ...
    function loadComponent(componentPath, targetSelector, config, callback) {
        ...
        fetch(componentPath)
            ...
            .then(function(html) {
                ...
                html = html.replace(/{LAB_NAME}/g, config.labName);
                html = html.replace(/{LAB_SUBTITLE}/g, config.labSubtitle);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var config = {
            basePath: basePath,
            labName: (body.dataset && body.dataset.labName) || 'MLDM Lab',
            labSubtitle: (body.dataset && body.dataset.labSubtitle) || 'UC Berkeley'
        };
